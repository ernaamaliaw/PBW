...
<main id="main" class="main">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a href="tambahberita.php" class="btn btn-primary mb-2">Tulis Berita</a>
                            </div>
            <div class="card-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <a href="deleteberita.php?id_berita=<?= $row['id_berita'];?>" class="btn btn-danger btn-sm">Hapus</a></td>
                  </tr> 
                  <!-- Modal -->
            <div class="modal fade" id="editModal<?= $i;?>" tabindex="-1" aria-labelledby="editModalLabel<?= $i;?>"
              ...
              <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                ...
                if(isset($_POST['simpan'])){
                    ...
                    $edit=  mysqli_query($conn, "UPDATE berita SET name_berita='$name_berita',isi_berita='$isi' WHERE id_berita='$id'");
                }
                ?>
                </tbody>
                    </table>
