...
<main id="main" class="main">
        ...
        <div class="card">
          ...
          <div class="form-floating mb-3">
            <textarea class="form-control" name="isi_berita" style="height: 100px;"></textarea>
        ...
        <?php
              if (isset($_POST['buat'])) {
                ...
                $edit=  mysqli_query($conn, "INSERT INTO berita SET name_berita='$name_berita',isi_berita='$isi'");
              }
              ?>
        </div>
    </div>
